...
// frame_jpeg.to_vec()
//imencode(&types::VectorOfu8, &buffer, &mut frame_png, &encode_params)?;

//let mut frame2 = Mat::default();
//imgproc::cvt_color_def(&buffer, &mut frame2, imgproc::COLOR_BGR2GRAY)?;

#[inline]
fn bgr_to_luma(&Bgr([b, g, r]): &Bgr) -> u8 {
    let l = SRGB_LUMA[0] * r as u32 + SRGB_LUMA[1] * g as u32 + SRGB_LUMA[2] * b as u32;
